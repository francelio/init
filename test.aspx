<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="SchoolSystem.test" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlUpdate" Visible="true">
        ...
        <ul>
            ...
            <li>
                <asp:Button ID="bntAtualizar" CssClass="btn btnEdit" runat="server" Text="Atualizar" Width="212px" />
            </li>
        </ul>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlCadastro" Visible="true">
        ...
        <ul>
            ...
            <li>
                <asp:Button ID="btnCadastrar" CssClass="btnAdd " runat="server" Text="Cadastrar" />
            </li>
        </ul>
          </asp:Panel>
